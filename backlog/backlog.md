...
Active features for galley. Check this before starting work.

| ID | Feature | Status | Branch |
| -- | ------- | ------ | ------ |
| F-001 | Monorepo skeleton (web, api, shared) | Done — initial port | claude/port-ai-gallery-mvp-Jvafk |
| F-002 | Shared types, constants, validator | Done — initial port | claude/port-ai-gallery-mvp-Jvafk |
| F-003 | Backend project CRUD + blueprint upload | Done — initial port | claude/port-ai-gallery-mvp-Jvafk |
| F-004 | Anthropic Q&A endpoint | Done — initial port | claude/port-ai-gallery-mvp-Jvafk |
